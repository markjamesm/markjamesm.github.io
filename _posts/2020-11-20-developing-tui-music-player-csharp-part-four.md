...
One of the key features of a music player is being able to load audio playlists, and so I wanted to make sure to implement this feature before a 1.0 release. I did some research and managed to find a great playlist library known as <a href="https://github.com/Zeugma440/atldotnet">atldotnet</a> which supports a multitude of formats, but for now I'll just be working with M3U since its ubiquitous. I decided to create a PlayListLoader class and place it inside my model folder as PlaylistLoader.cs. Inside the PlayListLoader class, I created a method which takes an M3U playlist filepath and returns the filepaths of the tracks inside it.  
